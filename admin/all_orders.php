...
<body class="fix-header fix-sidebar">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    if ($status == "in process") { ?>
                                                        <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> Trên đường giao!</button></td>
                                                    <?php
                                                    }
                                                    if ($status == "closed") {
                                                    ?>
                                                    ...
                                                    ?>
                                                    <td>
                                                        <a href="delete_orders.php?order_del=<?php echo $rows['o_id']; ?>" onclick="return confirm('Bạn có chắc không?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                                                <?php
    ...
    <script type="text/javascript" src="./js/alert_confirm.js"> </script>
