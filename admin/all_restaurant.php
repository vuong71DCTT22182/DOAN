                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo ' <tr><td>' . $row['c_name'] . '</td>
																								...
																								<td>' . $rows['date'] . '</td>
																									 <td><a href="delete_restaurant.php?res_del=' . $rows['rs_id'] . '" onclick="return confirm(`Bạn có chắc không?`);" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
