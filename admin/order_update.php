...
if (strlen($_SESSION['user_id']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        echo "<script>alert('Chi tiết biểu mẫu được cập nhật thành công'); window.close(); </script>";
    }
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td><select name="status" required="required">
                                ...
                                <option value="in process">Trên đường giao</option>
                    ...
                    <tr>
                        <td><b>Action</b></td>
                        <td><input type="submit" name="update" class="btn btn-primary" value="Nộp">
