    ...
    <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Đặt hàng Giao hàng & Mang đi </h1>
                ...
                <div class="steps">
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Gọi món</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Giao hàng hoặc mang đi</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">Cách dễ nhất để gọi món ăn yêu thích của bạn trong số 6 món ăn hàng đầu này</p>
            </div>
            <div class="row">
