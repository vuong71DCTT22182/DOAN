                            ...
                            (b.prototype.toggle = function() {
                                ...
                                if (c) {
                                    ...
                                    this._element.setAttribute(
                                        "aria-pressed", !a(this._element).hasClass(j.ACTIVE)
                                    );
                                    ...
                                    if (
                                        (this._parent &&
                                            ((c = a.makeArray(a(r.ACTIVES))),
                                                c.length || (c = null)), !(c && ((d = a(c).data(h)), d && d._isTransitioning)))
                                    ) {
                        ...
                        return (
                            (b.prototype.toggle = function() {
                                ...
                                var f = { relatedTarget: this },
                                    g = a.Event(o.SHOW, f);
                                return (
                                    a(c).trigger(g), !g.isDefaultPrevented() &&
                                    (this.focus(),
                                        this.setAttribute("aria-expanded", "true"),
                                        a(c).toggleClass(p.OPEN),
                                        a(c).trigger(a.Event(o.SHOWN, f)), !1)
                                );
                            }),
                            (b.prototype.dispose = function() {
                            ...
                            (b._clearMenus = function(c) {
                                if (!c || c.which !== n) {
                                    ...
                                    for (
                                        var e = a.makeArray(a(q.DATA_TOGGLE)), f = 0; f < e.length; f++
                                    ) {
                            ...
                            (b._dataApiKeydownHandler = function(c) {
                                if (
                                    ...
                                    !/input|textarea/i.test(c.target.tagName) &&
                                    (c.preventDefault(),
                                        c.stopPropagation(), !this.disabled && !a(this).hasClass(p.DISABLED))
                                ) {
                                ...
                                if (this._isShown && this._config.backdrop) {
                                    ...
                                    if (
                                        ((this._backdrop = document.createElement("div")),
                                            ...
                                            a(this._backdrop).addClass(r.IN), !b)
                                    )
                                        return;
                                    if (!e) return void b();
                                    a(this._backdrop)
                        ...
                        return (
                            (b.prototype.show = function() {
                                ...
                                if (!this._element.parentNode ||
                                    ...
                                    if (
                                        (d && a(d).trigger(h),
                                            a(this._element).trigger(i), !i.isDefaultPrevented() && !h.isDefaultPrevented())
                                    ) {
                        ...
                        return (
                            ...
                            (j.prototype.setElementContent = function(b, c) {
                                ...
                                e
                                    ...
                                    b.text(a(c).text()): b[e ? "html" : "text"](c);
                            }),
